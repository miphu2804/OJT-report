...
Thiết lập kho lưu trữ Terraform state file trên S3 trước khi chạy terraform init để quản lý trạng thái hạ tầng một cách nhất quán và bảo đảm khả năng truy vết thay đổi.
...
State file của Terraform là nguồn dữ liệu phản ánh trạng thái hạ tầng thực tế và được dùng để tính toán thay đổi khi chạy apply. Vì vậy, state cần được lưu trữ ở một backend riêng, ổn định và an toàn. Trong dự án này, S3 được lựa chọn làm nơi lưu trữ state thông qua bước **Ensure Terraform State Bucket Exists**.
