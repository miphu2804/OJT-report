...
- Outputs chỉ nên chứa dữ liệu phục vụ cho job kế tiếp, tránh đưa các giá trị thuộc nhóm bí mật cấu hình hoặc thông tin định danh nhạy cảm (ví dụ: access key, secret key, token, mật khẩu).
